...
REGISTER_CLASS_NAME(JPEGEncoderOptions,"flash.display")
REGISTER_CLASS_NAME(JPEGXREncoderOptions,"flash.display")
...
REGISTER_CLASS_NAME(NativeMenuItem,"flash.display")
REGISTER_CLASS_NAME(PixelSnapping,"flash.display")
REGISTER_CLASS_NAME(PNGEncoderOptions,"flash.display")
...
REGISTER_CLASS_NAME(GameInputEvent,"flash.ui")
...
REGISTER_CLASS_NAME(SampleDataEvent,"flash.events")
...
REGISTER_CLASS_NAME(ThrottleEvent,"flash.events")
REGISTER_CLASS_NAME(ThrottleType,"flash.events")
...
REGISTER_CLASS_NAME(LocaleID,"flash.globalization")
...
REGISTER_CLASS_NAME(CollatorMode,"flash.globalization")
REGISTER_CLASS_NAME(DateTimeNameContext,"flash.globalization")
REGISTER_CLASS_NAME(DateTimeNameStyle,"flash.globalization")
...
REGISTER_CLASS_NAME(MicrophoneEnhancedOptions,"flash.media")
...
REGISTER_CLASS_NAME(ID3Info,"flash.media")
...
REGISTER_CLASS_NAME2(ASSocket,"Socket","flash.net")
...
REGISTER_CLASS_NAME(GameInput,"flash.ui")
REGISTER_CLASS_NAME(GameInputDevice,"flash.ui")
...
REGISTER_CLASS_NAME2(AVM1MovieClipLoader,"MovieClipLoader","")
